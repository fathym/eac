...
We used `npx touch` touch here to support cross platform instructions where we assume node.js will
be installed. To use npm or npx throughout these docs, you will need to have the latest version of
node installed. For users with `touch` (like linux), you can use touch as you are used to.
