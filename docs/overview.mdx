...
you a leg up and starting point, and then lets you customize how an where your app is
...
AWS CloudFormation? We don't, use them all here. How do we compare to fly.io, Netlify and Vercel?  We don't, use them both here.
