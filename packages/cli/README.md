...
running command...
$ fathym (--version)
@fathym/cli/0.0.173 win32-x64 node-v18.12.1
$ fathym --help [COMMAND]
USAGE
  $ fathym COMMAND
...
...
_See code: [dist/commands/auth/index.ts](https://github.com/fathym/eac/blob/v0.0.173/dist/commands/auth/index.ts)_
...
_See code: [dist/commands/git/index.ts](https://github.com/fathym/eac/blob/v0.0.173/dist/commands/git/index.ts)_
...
_See code: [dist/commands/lcu/index.ts](https://github.com/fathym/eac/blob/v0.0.173/dist/commands/lcu/index.ts)_
...
_See code: [dist/commands/open.ts](https://github.com/fathym/eac/blob/v0.0.173/dist/commands/open.ts)_
