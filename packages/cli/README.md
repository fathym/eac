...
running command...
$ fathym (--version)
@fathym/cli/0.0.23 win32-x64 node-v18.12.1
$ fathym --help [COMMAND]
USAGE
  $ fathym COMMAND
...
...
_See code: [dist/commands/auth/index.ts](https://github.com/fathym/eac/blob/v0.0.23/dist/commands/auth/index.ts)_
...
_See code: [dist/commands/git/index.ts](https://github.com/fathym/eac/blob/v0.0.23/dist/commands/git/index.ts)_
