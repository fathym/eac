...
running command...
$ fathym (--version)
@fathym/cli/0.0.162 win32-x64 node-v18.12.1
$ fathym --help [COMMAND]
USAGE
  $ fathym COMMAND
...
...
* [`fathym dev lcu create react`](#fathym-dev-lcu-create-react)
...
_See code: [dist/commands/auth/index.ts](https://github.com/fathym/eac/blob/v0.0.162/dist/commands/auth/index.ts)_
...
## `fathym dev lcu create react`

Used to create a new react application.

```
USAGE
  $ fathym dev lcu create react [--json] [-m] [-t]
...
_See code: [dist/commands/git/index.ts](https://github.com/fathym/eac/blob/v0.0.162/dist/commands/git/index.ts)_
...
_See code: [dist/commands/lcu/index.ts](https://github.com/fathym/eac/blob/v0.0.162/dist/commands/lcu/index.ts)_
...
_See code: [dist/commands/open.ts](https://github.com/fathym/eac/blob/v0.0.162/dist/commands/open.ts)_
...
_See code: [dist/commands/upgrade.ts](https://github.com/fathym/eac/blob/v0.0.162/dist/commands/upgrade.ts)_
<!-- commandsstop -->
