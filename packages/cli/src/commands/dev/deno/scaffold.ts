      ...
      },
      {
        ...
        task: async (ctx, task) => {
          projectType = await task.prompt({
            ...
            choices: [{
              message: 'Module',
              name: 'https://deno.land/x/create_deno_module_project@v0.0.20-integration/cli.ts ',
            }, {
              message: 'Fresh',
              name: 'https://deno.land/x/create_deno_fresh_project@v0.0.5-integration/cli.ts ',
            }],
