      ...
      },
      {
        ...
        task: async (ctx, task) => {
          projectType = await task.prompt({
            ...
            choices: [{
              message: 'Module',
              name: 'https://deno.land/x/create_deno_module_project@v0.0.23-integration/cli.ts ',
            }, {
              message: 'Fresh',
              name: 'https://deno.land/x/create_deno_fresh_project@v0.0.7-integration/cli.ts ',
            }],
